...
public class ObjectModificationValidatorTestNew {
    ...
    public void testValidate_onlyAdditions() {
        ...
        ObjectModificationValidatorNew<HollowAPI, GenericHollowObject> validator = createValidator(filter);
    ...
    private static HollowProducer getProducer(ObjectModificationValidatorNew validator) {
    ...
    private ObjectModificationValidatorNew<HollowAPI, GenericHollowObject> createValidator(
            BiPredicate<GenericHollowObject, GenericHollowObject> filter) {
        return new ObjectModificationValidatorNew<>(TypeA.class.getSimpleName(), filter,
