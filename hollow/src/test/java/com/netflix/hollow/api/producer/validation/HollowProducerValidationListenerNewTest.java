...
public class HollowProducerValidationListenerNewTest {
    ...
    private void createHollowProducerAndRunCycle(final String typeName, boolean addPrimaryKeyValidator) {
        Validators.ValidatorListener dupeValidator = new DuplicateDataDetectionValidatorNew(typeName);
        Validators.ValidatorListener countValidator = new RecordCountVarianceValidatorNew(typeName, 3.0f);
    ...
    private void assertOnValidationStatus(int size, boolean passed, boolean isThrowableNull, long version) {
        Validators.ValidationStatus status = validationListener.getStatus();
    ...
    static class MovieWithPrimaryKey extends com.netflix.hollow.api.producer.validation.MovieWithoutPrimaryKey {
    ...
    static class TestValidationStatusListener implements Validators.ValidationStatusListener {
        private long version;
        private Validators.ValidationStatus status;
        ...
        public void onValidationStatusComplete(
                Validators.ValidationStatus status, long version, long elapsed, TimeUnit unit) {
            this.status = status;
        }
        ...
        public Validators.ValidationStatus getStatus() {
            return status;
        }
    ...
    static class TestCycleAndValidationStatusListener extends AbstractHollowProducerListener
            implements Validators.ValidationStatusListener {
