...
public class RecordCountVarianceValidatorNewTests {
    ...
    public void failTestTooManyAdded() {
        try {
            HollowProducer producer = HollowProducer.withPublisher(blobStore)
                    ...
                    .withListener(new RecordCountVarianceValidatorNew("TypeWithPrimaryKey", 1f)).build();
    ...
    public void passTestNoMoreChangeThanExpected() {
        HollowProducer producer = HollowProducer.withPublisher(blobStore).withBlobStager(new HollowInMemoryBlobStager())
                .withListener(new RecordCountVarianceValidatorNew("TypeWithPrimaryKey", 50f)).build();
    ...
    public void testGetChangePercent() {
        RecordCountVarianceValidatorNew val = new RecordCountVarianceValidatorNew("someType", 3.0f);
