...
public class HollowMapHashKeyTest {
    ...
    public void testMapHashKeys() throws IOException {
        ...
        mapper.add(new TestTopLevelObject(1,
                new Obj(1, "New York", "US", 100),
                new Obj(2, "Ottawa", "CA", 200),
                new Obj(3, "Rome", "IT", 300),
                new Obj(4, "London", "GB", 400),
                new Obj(5, "Turin", "IT", 500)));
        ...
        GenericHollowObject value = (GenericHollowObject) obj.getMap("mapById")
                .findValue(1);
