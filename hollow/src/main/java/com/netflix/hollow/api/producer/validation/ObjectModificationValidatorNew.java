 ...
 * }</pre>
 */
public class ObjectModificationValidatorNew<A extends HollowAPI, T extends HollowObject>
        implements Validators.ValidatorListener {
    ...
    public ObjectModificationValidatorNew(
