 ...
 */
public class RecordCountVarianceValidatorNew implements Validators.ValidatorListener {
    ...
    private static final String NAME = RecordCountVarianceValidatorNew.class.getName();
     ...
     * Anything more results in failure of validation.
     */
    public RecordCountVarianceValidatorNew(String typeName, float allowableVariancePercent) {
