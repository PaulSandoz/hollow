...
public class DuplicateDataDetectionValidatorNew implements Validators.Validator {
    ...
    private static final String NAME = DuplicateDataDetectionValidatorNew.class.getName();
     ...
     */
    public DuplicateDataDetectionValidatorNew(String dataTypeName) {
     ...
     */
    public DuplicateDataDetectionValidatorNew(String dataTypeName, String[] fieldPathNames) {
        this.dataTypeName = Objects.requireNonNull(dataTypeName);
